...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('flat_details', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('flat_budget_id');
            $table->foreign('flat_budget_id')->references('id')->on('flatbudgets')->onDelete('cascade')->change();
            $table->unsignedBigInteger('Material_details_id');
            $table->foreign('Material_details_id')->references('id')->on('materialdetails')->onDelete('cascade')->change();
