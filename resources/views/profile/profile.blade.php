                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="row align-items-center">
                                                <div class="col-auto">
                                                    <div class="avatar-lg">
                                                        <img src="{{ asset('public/assets/images/users/avatar-2.jpg') }}" alt="" class="rounded-circle img-thumbnail">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="inbox-widget">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="{{ asset('public/assets/images/users/avatar-2.jpg') }}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="{{ asset('public/assets/images/users/avatar-3.jpg') }}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="{{ asset('public/assets/images/users/avatar-4.jpg') }}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="{{ asset('public/assets/images/users/avatar-5.jpg') }}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="{{ asset('public/assets/images/users/avatar-6.jpg') }}" class="rounded-circle" alt=""></div>
