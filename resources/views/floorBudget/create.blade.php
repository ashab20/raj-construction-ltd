                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Floor Budget Create</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Floor Budget Create</h4>
                </div>
            </div>
        </div>      
    <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <select class="form-control" name="floorNo" id="floorNo">
                                                    ...
                                                    @forelse($floorbudget as $fBudget)
                                                        <option value="{{$fBudget->id}}" {{ old('floorNo')==$fBudget->id?"selected":""}}> {{ $fBudget->floor_no}}</option>
                                                    @empty
