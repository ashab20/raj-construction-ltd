                        ...
                        <form action="{{route('project.update',$project)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">                            
                                <div class="col-xl-4 mb-3">
                                    ...
                                    <input type="text" id="projectname" class="form-control" placeholder="Enter project name" name="projectNameInputField" value="{{ old('projectNameInputField',$project->project_name)}}" required>
                                </div>
...
{{-- - {{$onwer?->email}} - {{$onwer?->phone}} --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 mb-3 position-relative" id="datepicker1">
                                    ...
                                    value="{{ old('parojectStarDate',$project->start_date)}}"
                                    >
                                </div>
                                <div class="col-xl-4 position-relative" id="datepicker2">
                                    ...
                                    value="{{ old('parojectEndDate',$project->end_date)}}" >
                                </div>
                                <div class="col-xl-4 mb-3">
                                    ...
                                    value="{{ old('totalBudget',$project->budget)}}">
                                </div>
                            </div>
                            <div class="row">
                                {{-- <div class="col-xl-6"> --}}
